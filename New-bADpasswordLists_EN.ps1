...
$strNamesGeneral = @("Test", "Qwerty", "Qwert", "Qwer", 'Pa$$W0rd', "P@ssword", "P@ssw0rd", 'Pa$$word', "Passw0rd", "Password", "Welcome", "Start", "Summer", "Winter", "Autumn", "Spring", "Winter", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December", "Monday", "Tueday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday")
